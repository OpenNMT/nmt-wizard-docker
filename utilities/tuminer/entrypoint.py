...
def mineBitext(src_sents, trg_sents, x, y, x2y_ind, x2y_mean, y2x_ind, y2x_mean, outputF, encoding, margin, retrieval, threshold, verbose):
    ...
    def exec_function(self, args):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            if isinstance(args.gpuid, list):
                ...
                srcP = mp.Process(target=TokBpeEmb,
                                  args=(args.srclang, srcF_local, srcTokF, srcBpeF, srcEmbF, bpeCodesF_local, encoderF_local, args.verbose, args.gpuid[0]))
                srcP.start()

                tgtP = mp.Process(target=TokBpeEmb,
                                  args=(args.tgtlang, tgtF_local, tgtTokF, tgtBpeF, tgtEmbF, bpeCodesF_local, encoderF_local, args.verbose, args.gpuid[1]))
                tgtP.start()
            ...
            if args.mode == 'score':
                ...
                mineBitext(src_sents, trg_sents, x, y, x2y_ind, x2y_mean, y2x_ind, y2x_mean, outputF_local, args.encoding, margin, retrieval, args.threshold, args.verbose)
        #################
        # Save output
        #################
