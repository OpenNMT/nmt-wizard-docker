...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(substitute_word_prob=1, word_embedding_file="/nfs/SSALING-DATA/segal/dev/systran-docker/nmt-wizard-docker/test/corpus/resources/embeddings/dbpedia.ftz"), True, "hello.", ['translator.', 'dichotomy.', 'violin.', 'clarinetist.', 'luce.']),
    ],
)
