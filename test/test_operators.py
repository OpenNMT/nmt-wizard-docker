...
@pytest.mark.parametrize(
    ...
    [
        ("This is a test without parentheses.", "Ceci est un test sans parenthèses.", False, (None, None)),
        ("This () is a test with one parenthesis in source.", "Ceci est un test avec une parenthèse en source.", False, ("This is a test with one parenthesis in source.", None)),
        ("This is a test with one parenthesis in target.", "Ceci est un test avec (une parenthèse en cible)", False, (None, "Ceci est un test avec")),
        ("This is a test with one parenthesis (in source) and one in target.", "Ceci est un test avec une parenthèse en source (et une en cible).", False, (None, None)),
        ("This is a test with (two) parentheses in source and (none) in target.", "Ceci est un test avec deux parenthèses en source et aucune en cible.", True, (None, None)),
        ("(This is a test with two) parentheses in source and (two) in target.", "Ceci est un test avec (deux parenthèses en source) et (deux en cible).", False, (None, None)),
        ("This is a test with (two) parentheses in source and (three in target)", "Ceci est un test avec (deux) parenthèses (en source) et (trois) en cible.", True, (None, None)),
        ("This is a test with (mismatched> parentheses in source.", "Ceci est un test avec des parenthèses incorrectes en source.", True, (None, None)),
        ("This is another test with (mismatched < parentheses in source.", "Ceci est un (autre) test avec des parenthèses incorrectes en source.", True, (None,None)),
        ("This a yest another test with (mismatched parentheses in source.", "Ceci est <encore un autre> test avec des (parenthèses) incorrectes en source.", True, (None, None)),
        ("This is a (test (with nested) parentheses) in source.", "Ceci est un test avec des parenthèses imbriquées en source.", True, (None, None)),
        ("This is another <test (with nested) parentheses> in source.", "Ceci est un <autre> test avec <des parenthèses imbriquées> en source.", True, (None, None)),
        ("This is a test with (mismatched) parentheses in target.", "Ceci est un test avec des (parenthèses (incorrectes en cible.", True, (None, None)),
        ("This is another test with (mismatched) parentheses in target.", "Ceci est un autre test avec des <parenthèses <incorrectes en cible.", True, (None, None)),
        ("This a yest another test with <mismatched> parentheses in target.", "Ceci est encore un autre test avec des <parenthèses incorrectes) en cible.", True, (None, None)),
        ("This is a (test) (with nested) (parentheses) in target.", "Ceci est un <test avec <des parenthèses imbriquées> en cible>.", True, (None, None)),
        ("This is another <test (with nested) parentheses> in target.", "Ceci est un autre <test avec (des parenthèses imbriquées) en cible>.", True, (None, None)),
        ("<This is> a more complicated (test) not to filter (and not to) modify.", "(Ceci est) un test plus compliqué à ne pas <filter> ni (modifier)", False, (None, None)),
        ("(This is) a more complicated (test) <to modify>.", "(Ceci) est (un test) plus compliqué à modifier.", False, ("(This is) a more complicated (test).", None)),
        ("(And) yet another test to modify.", "Et encore un test <à modifier>", False, ("yet another test to modify.", "Et encore un test")),
        ("Test for(joiner)replacement.", "Teste pour remplacer le joiner.", False, ("Test forreplacement.", None)),
        ("Test for joiner replacement.", "Teste pour remplacer(le)joiner.", False, (None, "Teste pour remplacerjoiner.")),
    ],
)
