...
class Utility(abc.ABC):
    ...
    def run(self, args=None):
        ...
        parser.add_argument(
            "-t", "--task_id", default=None, help="Identifier of this run."
        )
        parser.add_argument(
            "-i",
            "--image",
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "Endpoint that listens to beat requests "
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "Endpoint that listens to statistics summaries generated "
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "Configuration as a file or a JSON string. "
                'Setting "-" will read from the standard input.'
            ),
        )
        parser.add_argument(
            ...
            default="default",
            help=(
                "How to update the parent task configuration with the given "
                "configuration. "
        ...
        parser.add_argument(
            "--no_push", default=False, action="store_true", help="Do not push model."
        )
        ...
        for val in nextval:
            ...
            for remote_input in inputs:
                local_input = os.path.join(
                    self._data_dir, self._storage.split(remote_input)[-1]
                )
                if is_dir:
